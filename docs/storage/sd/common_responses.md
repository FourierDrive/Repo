...
| Field | Start bit | Direction | Reserved | Card power up status bit (busy) | Card capacity status (CCS) | UHS-II card status | Reserved | Card over 2 TB support status (CO2T) | Reserved | Switching to 1.8 V accepted (S18A) | VDD voltage window | Reserved | End bit |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Position** | [47] | [46] | [45:40] | [39] (OCR [31]) | [38] (OCR [30]) | [37] (OCR [29]) | [36] (OCR [28]) | [35] (OCR [27]) | [34:33] (OCR [26:25]) | [32] (OCR [24]) | [31:8] (OCR [23:0]) | [7:1] | [0] |
| **Length** | 1 bit | 1 bit | 6 bits | 1 bit | 1 bit | 1 bit | 1 bit | 1 bit | 2 bits | 1 bit | 24 bits | 7 bits | 1 bit |
| **Value** | `0` | `0` | `all 1` | `0` (Incomplete)<br>`1` (Complete) | `0` (SDSC)<br>`1` (With CO2T) | `0` (Not UHS-II)<br>`1` (Is UHS-II) | `1` | `0` (SDHC/SDXC)<br>`1` (SDUC) | `all 1` | `0` (Not accepted)<br>`1` (Accepted) | See definition table below | `x` | `1` |
...
| Field | Start bit | Direction | Command index | New published RCA | Card status | CRC7 | End bit |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Position** | [47] | [46] | [45:40] | [39:24] (RCA [31:16]) | [23:8] (RCA [15:0]) | [7:1] | [0] |
| **Length** | 1 bit | 1 bit | 6 bits | 16 bits | 16 bits | 7 bits | 1 bit |
| **Value** | `0` | `0` | `000011b` | `x` | Memory card returns status bits [23], [22], [19], [12:9]<br>I/O card returns status bits [23], [22], [19] | `x` | `1` |
...
| Field | Start bit | Direction | Command index | Reserved | PCIe 1.2V support | PCIe response | Voltage accepted | Echo back of check pattern | CRC7 | End bit |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
| **Value** | `0` | `0` | `001000b` | `all 0` | `0` (Supported)<br>`1` (Not supported) | `0` (Accepted)<br>`1` (Not accepted) | `0001b` (2.7V ~ 3.6V)<br>`0010b` (Low voltage) | Matches corresponding command `CMD8` check byte value | `x` | `1` |

## IO_SEND_OP_COND Response (R4)

The contents of the SDIO card's OCR as a response to command **CMD5**.

| Field | Start bit | Direction | Reserved | Operating status | Number of I/O functions | Memory present | Stuff bits | Switching to 1.8 V accepted (S18A) | I/O OCR | Reserved | End bit |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Position** | [47] | [46] | [45:40] | [39] | [38:36] | [35] | [34:33] | [32] | [31:8] (OCR [23:0]) | [7:1] | [0] |
| **Length** | 1 bit | 1 bit | 6 bits | 1 bit | 3 bits | 1 bit | 2 bits | 1 bit | 24 bits | 7 bits | 1 bit |
| **Value** | `0` | `0` | `all 1` | `0` (Incomplete)<br>`1` (Complete) | Number of I/O functions (excluding function `0`) | `0` (I/O only)<br>`1` (Includes memory) | `all 0` | `0` (Not accepted)<br>`1` (Accepted) | `x` | `all 1` | `1` |

## IO_RW_DIRECT Response (R5)

Response to command **CMD52**. Returns the device's current working status.

| Field | Start bit | Direction | Command index | Stuff bits | Response flags bit | Read or write data | CRC7 | End bit |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Position** | [47] | [46] | [45:40] | [39:24] | [23:16] | [15:8] | [7:1] | [0] |
| **Length** | 1 bit | 1 bit | 6 bits | 16 bits | 8 bits | 8 bits | 7 bits | 1 bit |
| **Value** | `0` | `0` | `110100b` | `all 0` | See definition table below | `R/W=0`: Specific address<br>`R/W=1` & `RAW=0`: Passed value<br>`R/W=1` & `RAW=1`: Read-back value | `x` | `1` |
...
| **[5:4]** | I/O current state | S | `00`: Init, standby, inactive<br>`01`: Command state<br>`10`: Data transfer state | B |
